 ...
 *   - Segment timing anchors (pulseqlib__calc_segment_timing) -- parse-time
...
/*  (relocated from pulseqlib_safety.c: these are parse-time timing    */
